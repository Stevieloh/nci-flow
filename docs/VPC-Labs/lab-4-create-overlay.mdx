...
3.  From the VPC navigation bar, choose Subnets.
    - Click Create Subnet.  The information for the 4 subnets are as per below
        ...
        a.  <li>Subnet #1</li>
            <li>Name:   Web-Subnet </li>
            <li>Network IP address/ Prefix:     10.1.1.0/24</li>
            <li>Gateway IP Address:             10.1.1.1</li>
            <li>IP Pool:                        Starting IP address 10.1.1.50 , Ending IP address : 10.1.1.200</li>
